...
# Remove grocery / food items completely
banned = [
    "water", "juice", "fish", "beef", "vegetable", "fruit",
    "oil", "food", "snack", "milk", "onion", "tomato",
    "apple", "banana", "potato", "strawberry", "kiwi"
]
...
print("✔ Products scraped successfully (API + Books)")
